...
export interface MusicShopInterface extends utils.Interface {
  functions: {
    "addAlbuym(string,string,uint256,uint256)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "addAlbuym", data: BytesLike): Result;
